...
namespace AlgoProject
{
    ...
    public class mapping_functions
    {
     ...
     /*   static void Main(string[] args)
        ...
        public string[] mappingFunc1(List<words> word, int size, int ID)
        {
            int low = 0;
            int high = size - 1;
            int mid = 0;
        ...
        public List<words> ReadFile(string path)
        {
        ...
        public List<int> mappingFunc2(List<words> word, int size, string synset)
        {
